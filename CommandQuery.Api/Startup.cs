...
public class Startup
{
    ...
    {
        // Build Configuration from 3 files that each ovverride previous values. 
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddSingleton(Configuration.GetSection("CommandQuerySettings").Get<CommandQuerySettings>());
    }
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseMiddleware<CommandQueryMiddleware>();
